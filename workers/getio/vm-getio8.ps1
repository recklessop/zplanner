...
$csvPath = "/home/zplanner/data/stats8.csv"
$vmlist = "/home/zplanner/data/vmlist8.csv"
...
/usr/bin/php /home/zplanner/zplanner/loaders/loadmysql.php stats8.csv
...
$file = "/home/zplanner/logs/" + $now + "-getio8.log"
