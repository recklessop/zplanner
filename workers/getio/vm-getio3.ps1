...
$csvPath = "/home/zplanner/data/stats3.csv"
$vmlist = "/home/zplanner/data/vmlist3.csv"
...
/usr/bin/php /home/zplanner/zplanner/loaders/loadmysql.php stats3.csv
...
$file = "/home/zplanner/logs/" + $now + "-getio3.log"
