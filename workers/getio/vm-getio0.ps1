...
$csvPath = "/home/zplanner/data/stats0.csv"
$vmlist = "/home/zplanner/data/vmlist0.csv"
...
/usr/bin/php /home/zplanner/zplanner/loaders/loadmysql.php stats0.csv
...
$file = "/home/zplanner/logs/" + $now + "-getio0.log"
