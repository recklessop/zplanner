...
$csvPath = "/home/zplanner/data/stats2.csv"
$vmlist = "/home/zplanner/data/vmlist2.csv"
...
/usr/bin/php /home/zplanner/zplanner/loaders/loadmysql.php stats2.csv
...
$file = "/home/zplanner/logs/" + $now + "-getio2.log"
