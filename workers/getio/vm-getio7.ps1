...
$csvPath = "/home/zplanner/data/stats7.csv"
$vmlist = "/home/zplanner/data/vmlist7.csv"
...
/usr/bin/php /home/zplanner/zplanner/loaders/loadmysql.php stats7.csv
...
$file = "/home/zplanner/logs/" + $now + "-getio7.log"
