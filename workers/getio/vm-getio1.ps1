...
$csvPath = "/home/zplanner/data/stats1.csv"
$vmlist = "/home/zplanner/data/vmlist1.csv"
...
/usr/bin/php /home/zplanner/zplanner/loaders/loadmysql.php stats1.csv
...
$file = "/home/zplanner/logs/" + $now + "-getio1.log"
