...
$csvPath = "/home/zplanner/data/stats4.csv"
$vmlist = "/home/zplanner/data/vmlist4.csv"
...
/usr/bin/php /home/zplanner/zplanner/loaders/loadmysql.php stats4.csv
...
$file = "/home/zplanner/logs/" + $now + "-getio4.log"
