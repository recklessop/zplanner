...
$csvPath = "/home/zplanner/data/stats9.csv"
$vmlist = "/home/zplanner/data/vmlist9.csv"
...
/usr/bin/php /home/zplanner/zplanner/loaders/loadmysql.php stats9.csv
...
$file = "/home/zplanner/logs/" + $now + "-getio9.log"
