...
$csvPath = "/home/zplanner/data/stats5.csv"
$vmlist = "/home/zplanner/data/vmlist5.csv"
...
/usr/bin/php /home/zplanner/zplanner/loaders/loadmysql.php stats5.csv
...
$file = "/home/zplanner/logs/" + $now + "-getio5.log"
